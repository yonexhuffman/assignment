		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					...
					<img alt="" class="img-circle" src="<?=base_url($admin_photo_path . $cur_userdata['t_photo'])?>"/>
					...
					<ul class="dropdown-menu dropdown-menu-default">
						<li>
							<a href="#">
							<i class="icon-user"></i> 姓名 : <?=$cur_userdata['t_name']?> </a>
						</li>
						<li>
							<a href="#">
							<i class="icon-calendar"></i> 出生日期 : <?=$cur_userdata['t_birth']?> </a>
						</li>
						<li class="divider">
						</li>
						<li>
							<a href="<?=site_url('/admininfo')?>">
							<i class="icon-lock"></i> 个人信息更新 </a>
						</li>
						<li>
